...
export class ALPNProtocols1691817588169 implements MigrationInterface {
  name = 'ALPNProtocols1691817588169'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_ConnectionEntity" (
                ...
                "reconnectPeriod" integer NOT NULL DEFAULT (4000),
                "ALPNProtocols" varchar,
