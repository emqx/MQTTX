export default {
  ...
  qosSubFailed: {
    ...
    tr: 'Beklenmeyen QoS, SubACK başarısız oldu, Lütfen MQTT aracı yapılandırmasını kontrol edin',
    ja: '予期しないQoS, MQTT broker 構成を確認してください',
    hu: 'Váratlan QoS, sikertelen SubACK, kérjük ellenőrizze az MQTT bróker konfigurációt',
  },
  emptySubFailed: {
    zh: '订阅为空',
  ...
  messageExpiryInterval: {
    ...
    tr: 'Sona Erme Aralığı',
    ja: '遺言有効期限',
    hu: 'Will lejárati intervallum',
  },
  contentType: {
    zh: '遗嘱消息描述',
    en: 'Content Type',
  ...
  isUTF8Data: {
    ...
    tr: 'UTF-8 Kodlu Veridira',
    ja: 'UTF-8エンコードデータ',
    hu: 'UTF8 kódolású adat',
  },
  duplicateName: {
    zh: '该名称已存在，请重新命名！',
