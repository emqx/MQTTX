export default {
  ...
  cloud: {
    zh: '需要一个云原生的全托管 MQTT 服务？一键部署 {cloud}！14 天免费试用！',
    en: 'Need a Fully Managed, Cloud-Native MQTT Messaging Service? Try {cloud} now! 14-day trial, no credit card required.',
    tr: 'Cloud-Native, tam olarak yönetilen bir MQTT aracısına mı ihtiyacınız var? Deneyin {cloud} şimdi! 14 günlük deneme, kredi kartı gerekmez.',
    ja: 'フルマネージドのクラウドネイティブMQTTメッセージングサービスが必要ですか？今すぐ{cloud}をお試しください。30日間の試用版で、クレジットカードは必要ありません。',
    hu: 'Teljesen felügyelt, felhőalapú MQTT üzenetküldő szolgáltatásra van szüksége? Próbálja ki az {cloud} szolgáltatást most! 14 napos próbaverzió, hitelkártya nélkül.',
  },
  duplicate: {
    zh: '复制连接',
    en: 'Duplicate',
