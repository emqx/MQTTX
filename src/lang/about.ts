export default {
  ...
  mqttxDesc: {
    ...
    en: 'MQTT X is an open source MQTT 5.0 cross-platform desktop client from EMQ, designed to help developers develop and debug MQTT services and applications faster.',
  ...
  cloudSummary: {
    ...
    en: 'EMQX Cloud is a fully managed MQTT cloud service platform provided by EMQ, which can connect massive IoT devices and process data in real time, and supports pay-as-you-go.',
